...
class phpbb_ext_gallery_tests_album_base_move_test extends phpbb_ext_gallery_tests_album_nestedset_base
{
	...
	*/
	public function test_move($explain, $album_id, $delta, $expected_moved, $expected)
	{
		...
		$this->assertEquals($expected_moved, $album->move($delta));
	...
	*/
	...
	{
		$album = $this->factory->get($album_id);
		$this->assertEquals($expected_moved, $album->move_down());
	...
	*/
	...
	{
		$album = $this->factory->get($album_id);
		$this->assertEquals($expected_moved, $album->move_up());
	...
	*/
	...
	{
		$album = $this->factory->get($album_id);
		$this->assertEquals($expected_moved, $album->move_children($target_id));
	...
	*/
	...
	{
		$album = $this->factory->get($album_id);
		$this->assertEquals($expected_moved, $album->change_parent($target_id));
