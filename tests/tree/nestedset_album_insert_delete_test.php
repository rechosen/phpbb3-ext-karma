...
class phpbb_ext_gallery_tests_tree_nestedset_album_add_remove_test extends phpbb_ext_gallery_tests_tree_nestedset_album_base
{
	...
	*/
	...
	{
		$this->assertEquals($expected_deleted, $this->set->delete($album_id));
		...
		return array(
			array(
				...
				array(
					...
					array('album_id' => 15, 'parent_id' => 0, 'user_id' => 0, 'left_id' => 23, 'right_id' => 24),
	...
	*/
	public function test_insert($new_album_data, $expected_data, $expected)
	{
		$this->assertEquals($expected_data, $this->set->insert($new_album_data));
