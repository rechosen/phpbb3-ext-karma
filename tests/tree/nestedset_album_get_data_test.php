...
class phpbb_ext_gallery_tests_tree_nestedset_album_get_data_test extends phpbb_ext_gallery_tests_tree_nestedset_album_base
{
	...
	*/
	...
	{
		$this->assertEquals($expected, array_keys($this->set->get_path_and_subtree_data($album_id, $order_asc, $include_item)));
	}
	...
	*/
	...
	{
		$this->assertEquals($expected, array_keys($this->set->get_path_data($album_id, $order_asc, $include_item)));
	}
	...
	*/
	...
	{
		$this->assertEquals($expected, array_keys($this->set->get_subtree_data($album_id, $order_asc, $include_item)));
	}
	...
	*/
	public function test_get_path_basic_data($album_id, $album_parents, $expected)
	{
		...
		$this->assertEquals($expected, array_keys($this->set->get_path_basic_data($album_data)));
	}
}
